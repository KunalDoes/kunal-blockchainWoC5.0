...
function showGameOver() {
  ...
  ctx.font = `${fontSize}px Cyberpunk`;
  ctx.fillStyle = "rgba(255, 251, 124, 0.879)";
  const x = (canvas.width / 4.5) - 130;
  const y = canvas.height / 2;
  ctx.fillText("GAME OVER", x, y);
  // document.getElementById('gameOverA').play(s);
}
